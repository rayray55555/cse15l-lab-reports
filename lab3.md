...
6. Example 2 - find all the files in a specific directory  
```java
...
7. -mtime in find Example 1 - using -mtime -7 to find the files in a directory that is modified within the last 7 days  
```java
